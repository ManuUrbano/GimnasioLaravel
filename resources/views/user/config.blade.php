    ...
    <form method="POST" action="{{ url('/user/update/'.Auth::user()->id) }}">
        ...
        <div class="w-full sm:max-w-lg mx-auto mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div class="mt-4">
                ...
                <x-input id="dni" class="block mt-1 w-full" type="text" name="dni" :value="Auth::user()->dni" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" :value="Auth::user()->nombre" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="apellidos" class="block mt-1 w-full" type="text" name="apellidos" :value="Auth::user()->apellidos" required />
            </div>
